...
public class UserDetailServiceImpl implements UserDetailsService {
	...
	private final ApplicationUserRepo repository;

	@Autowired
	public UserDetailServiceImpl(ApplicationUserRepo applicationUserRepository) {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		//		ApplicationUser curruser = repository.findById(6);
		log.info(curruser.getFirstName());
